...
## into two by two table by collapsing the first and the second outcome levels also
## the first and the second treatment levels, this is then the usual Fisher's exact
library(Rcpp)
...
while(count < end.count) {
  ...
  ## collapsing the first and the second outcome level, also the first and the second
  ## treatment levels
  observed.table = matrix(data=c(n11+n12,n13,n21+n22+n31+n32,n23+n33),nrow = 2,byrow=T)



  ## compute the pvalue, and note the treatment level has been collapsed
...
cat("number of rejections under treatment model weighted four corners for the binarized
    the first and the second outcome together and binarizing the first and second
