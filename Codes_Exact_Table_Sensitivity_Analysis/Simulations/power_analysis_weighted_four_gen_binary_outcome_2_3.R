...
## we will try gamma from 0 to 2.3 (\Gamma \approx 10). See Section 7 for details.
library(Rcpp)
...
while(count < end.count) {
  ...
  ## binarizing the table, thus, combined the latter two outcome levels
...
cat("number of rejections under treatment model weighted four corners for the binarized
    the second and the third outcome together
